...
// Verificar si el usuario es ofertante (perfil_id = 3)
if (!isset($_SESSION['perfil_id']) || $_SESSION['perfil_id'] != 3) {
...
// Consulta para obtener las actividades creadas por el usuario
$consulta = "SELECT id, nombre, descripcion, fecha_actividad, aforo, visada 
             FROM ofertas 
...
<head>
    ...
    <title>Mis Actividades creadas</title>
    ...
    <main class="container mx-auto p-6 flex-grow">
        ...
        <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-6">
            <?php if (!empty($actividades_apuntadas)): ?>
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-4 flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-gray-800 text-sm font-semibold">
                                Estado: 
                                <?php echo ($actividad['visada'] == 1) ? '<span class="text-green-600">Visada</span>' : '<span class="text-red-600">No visada</span>'; ?>
                            </p>
                        </div>
                        <div class="flex space-x-2">
                            <!-- Mostrar botón de borrar solo si no está visada -->
                            <?php if ($actividad['visada'] == 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p class="text-center text-gray-600 text-xl col-span-3">No tienes actividades creadas.</p>
            <?php endif; ?>
        </div>
    </main>
